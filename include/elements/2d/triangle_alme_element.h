#ifndef MPM_ALME_TRI_ELEMENT_H
#define MPM_ALME_TRI_ELEMENT_H

#include "triangle_element.h"

namespace mpm {

//! Triangular Anisotropic Local Maximum Entropy element class derived from
//! Triangular \brief Triangular ALME element \details Triangular ALME element
//! with adaptive number of nodes \n Type of elements and sizes of shape
//! function, gradient shape function, B-matrix, indices are according to the
//! number of nodes \n <pre>
//!
...
class TriangleALMEElement : public TriangleElement<2, 3> {
 ...
 public:
  ...
  TriangleALMEElement() : TriangleElement<2, 3>() {
    static_assert(Tdim == 2, "Invalid dimension for a ALME element");

    //! Logger
    std::string logger = "triangle_ALME::<" + std::to_string(Tdim) + ">";
...
#include "triangle_alme_element.tcc"

#endif  // MPM_ALME_TRI_ELEMENT_H
