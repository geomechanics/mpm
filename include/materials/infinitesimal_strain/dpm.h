#ifndef MPM_MATERIAL_DPM_H_
#define MPM_MATERIAL_DPM_H_
...
//! Dilatant plasticity model class
//! \brief DPM material model
...
class DilatantPlasticModel : public InfinitesimalElastoPlastic<Tdim> {
 public:
  ...
  DilatantPlasticModel(unsigned id, const Json& material_properties);

  //! Destructor
  ~DilatantPlasticModel() override {};

  //! Delete copy constructor
  DilatantPlasticModel(const DilatantPlasticModel&) = delete;

  //! Delete assignement operator
  DilatantPlasticModel& operator=(const DilatantPlasticModel&) = delete;
...
};  // DilatantPlasticModel class
}  // namespace mpm

#include "dpm.tcc"

#endif  // MPM_MATERIAL_DPM_H_
