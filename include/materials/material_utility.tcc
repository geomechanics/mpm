...
inline const Eigen::Matrix<double, 3, 1> mpm::materials::principal_tensor(
  ...
  Eigen::MatrixXd full_tensor(3, 3);
  full_tensor(0, 0) = voigt_tensor(0);
  full_tensor(1, 1) = voigt_tensor(1);
  full_tensor(2, 2) = voigt_tensor(2);
  full_tensor(0, 1) = voigt_tensor(3);
  full_tensor(1, 0) = full_tensor(0, 1);
  full_tensor(1, 2) = voigt_tensor(4);
  full_tensor(2, 1) = full_tensor(1, 2);
  full_tensor(0, 2) = voigt_tensor(5);
  full_tensor(2, 0) = full_tensor(0, 2);
  Eigen::SelfAdjointEigenSolver<Eigen::MatrixXd> es(full_tensor);
