...
inline Eigen::MatrixXd
    mpm::ParticleLevelsetBbar<1>::compute_bmatrix() noexcept {
...
template <>
inline Eigen::MatrixXd
    mpm::ParticleLevelsetBbar<2>::compute_bmatrix() noexcept {
  Eigen::MatrixXd bmatrix;
...
template <>
inline Eigen::MatrixXd
    mpm::ParticleLevelsetBbar<3>::compute_bmatrix() noexcept {
  Eigen::MatrixXd bmatrix;
...
template <>
inline Eigen::Matrix<double, 6, 1>
    mpm::ParticleLevelsetBbar<1>::compute_strain_increment(
        const Eigen::MatrixXd& dn_dx, unsigned phase) noexcept {
...
template <>
inline Eigen::Matrix<double, 6, 1>
    mpm::ParticleLevelsetBbar<2>::compute_strain_increment(
        const Eigen::MatrixXd& dn_dx, unsigned phase) noexcept {
...
template <>
inline Eigen::Matrix<double, 6, 1>
    mpm::ParticleLevelsetBbar<3>::compute_strain_increment(
        const Eigen::MatrixXd& dn_dx, unsigned phase) noexcept {
  // Define strain increment
  Eigen::Matrix<double, 6, 1> strain_increment =
      Eigen::Matrix<double, 6, 1>::Zero();
