...
#include "particle_finite_strain_fbar.h"
...
// Particle2D with finite strain formulation and F-bar method (2 Dim)
static Register<mpm::ParticleBase<2>, mpm::ParticleFiniteStrainFbar<2>,
                mpm::Index, const Eigen::Matrix<double, 2, 1>&>
    particle2dfinitestrainfbar("P2DFSFBAR");

// Particle3D with finite strain formulation and F-bar method (3 Dim)
static Register<mpm::ParticleBase<3>, mpm::ParticleFiniteStrainFbar<3>,
                mpm::Index, const Eigen::Matrix<double, 3, 1>&>
    particle3dfinitestrainfbar("P3DFSFBAR");