...
const size_t dst_offset[NFIELDS] = {
    ...
    HOFFSET(PODParticle, initialise_mapping_matrix),
    HOFFSET(PODParticle, mapping_matrix_00),
    HOFFSET(PODParticle, mapping_matrix_01),
    HOFFSET(PODParticle, mapping_matrix_02),
    HOFFSET(PODParticle, mapping_matrix_10),
    HOFFSET(PODParticle, mapping_matrix_11),
    HOFFSET(PODParticle, mapping_matrix_12),
    HOFFSET(PODParticle, mapping_matrix_20),
    HOFFSET(PODParticle, mapping_matrix_21),
    HOFFSET(PODParticle, mapping_matrix_22),
    ...
    HOFFSET(PODParticle, svars[20]),
    HOFFSET(PODParticle, svars[21]),
    HOFFSET(PODParticle, svars[22]),
    HOFFSET(PODParticle, svars[23]),
    HOFFSET(PODParticle, svars[24]),
    HOFFSET(PODParticle, svars[25]),
    HOFFSET(PODParticle, svars[26]),
    HOFFSET(PODParticle, svars[27]),
    HOFFSET(PODParticle, svars[28]),
    HOFFSET(PODParticle, svars[29]),
    HOFFSET(PODParticle, svars[30]),
    HOFFSET(PODParticle, svars[31]),
    HOFFSET(PODParticle, svars[32]),
    HOFFSET(PODParticle, svars[33]),
    HOFFSET(PODParticle, svars[34]),
    HOFFSET(PODParticle, svars[35]),
    HOFFSET(PODParticle, svars[36]),
    HOFFSET(PODParticle, svars[37]),
    HOFFSET(PODParticle, svars[38]),
    HOFFSET(PODParticle, svars[39]),
    HOFFSET(PODParticle, svars[40]),
    HOFFSET(PODParticle, svars[41]),
    HOFFSET(PODParticle, svars[42]),
    HOFFSET(PODParticle, svars[43]),
    HOFFSET(PODParticle, svars[44]),
    HOFFSET(PODParticle, svars[45])};

// Get size of particle
PODParticle particle;
const size_t dst_sizes[NFIELDS] = {sizeof(particle.id),
