...
TEST_CASE("Triangle lme elements are checked", "[tri][element][2D][lme]") {
  ...
  SECTION("Linear Triangle LME Element") {
    ...
    SECTION("2D triangle LME element regular element - nnodes = 108") {
      ...
      SECTION("2D triangle ALME regular element no support") {
        double gamma = 0.5;
        double h = 1.0;
    ...
    SECTION("2D triangle LME element regular element - nnodes = 108") {
      Eigen::Matrix<double, 108, Dim> nodal_coords;
      nodal_coords << 5.19615242, 1.5, 5.19615242, -0.5, 0., 0.5, 0., -1.5, 0.,
          0., 0.8660254, 1., 0.8660254, -1., 0.8660254, 0., -0.8660254, 1.,
          -0.8660254, -1., -0.8660254, 0.5, 1.73205081, -0.5, 1.73205081, -1.5,
          1.73205081, -3.5, -3.46410162, -2.5, -3.46410162, -4.5, -3.46410162,
          -3., -2.59807621, -2., -2.59807621, -4., -2.59807621, -3.,
          -4.33012702, -2., -4.33012702, -4., -4.33012702, -2.5, -1.73205081,
          -3.5, -1.73205081, -4.5, -1.73205081, -3.5, 0., -2.5, 0., -4.5, 0.,
          -3., 0.8660254, -2., 0.8660254, -4., 0.8660254, -3., -0.8660254, -2.,
          -0.8660254, -4., -0.8660254, -2.5, 1.73205081, -3.5, 1.73205081, -4.5,
          1.73205081, -3.5, 3.46410162, -2.5, 3.46410162, -4.5, 3.46410162, -3.,
          4.33012702, -2., 4.33012702, -4., 4.33012702, -3., 2.59807621, -2.,
          2.59807621, -4., 2.59807621, -2.5, 5.19615242, -3.5, 5.19615242, -4.5,
          5.19615242, -0.5, -3.46410162, 0.5, -3.46410162, -1.5, -3.46410162,
          0., -2.59807621, 1., -2.59807621, -1., -2.59807621, 0., -4.33012702,
          1., -4.33012702, -1., -4.33012702, 0.5, -1.73205081, -0.5,
          -1.73205081, -1.5, -1.73205081, -0.5, 3.46410162, 0.5, 3.46410162,
          -1.5, 3.46410162, 0., 4.33012702, 1., 4.33012702, -1., 4.33012702, 0.,
          2.59807621, 1., 2.59807621, -1., 2.59807621, 0.5, 5.19615242, -0.5,
          5.19615242, -1.5, 5.19615242, 2.5, -3.46410162, 3.5, -3.46410162, 1.5,
          -3.46410162, 3., -2.59807621, 4., -2.59807621, 2., -2.59807621, 3.,
          -4.33012702, 4., -4.33012702, 2., -4.33012702, 3.5, -1.73205081, 2.5,
          ...
          1.73205081, 2.5, 3.46410162, 3.5, 3.46410162, 1.5, 3.46410162, 3.,
          4.33012702, 4., 4.33012702, 2., 4.33012702, 3., 2.59807621, 4.,
          2.59807621, 2., 2.59807621, 3.5, 5.19615242, 2.5;

      // Exced maximum number of interations
      SECTION("2D LME element for coordinates(0.5, 0.0)") {
        double gamma = 0.5;
        double h = 1.0;
