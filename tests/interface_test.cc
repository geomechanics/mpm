...
TEST_CASE("Interface functions are checked", "[interface]") {
  ...
  // clang-format off
  displacements << 0.0309142562, -0.009103645421,
                   0.0809142562,   0.04089635458,
                   0.0309142562, -0.006301652893,
                   0.0809142562,   0.04369834711,
                   0.0309142562,   0.01561393152,
                   0.0809142562,   0.06561393152,
                   0.0309142562, -0.001652892562,
                   0.0809142562,   0.04834710744;
  // clang-format on

  Eigen::Matrix<double, 8, 2> separation;
  // clang-format off
  separation << -0.04001790162,  0.04001790162,
                -0.04001790162,  0.04001790162,
                -0.03721590909,  0.03721590909,
                -0.03721590909,  0.03721590909,
                -0.01530032468,  0.01530032468,
                -0.01530032468,  0.01530032468,
                -0.03256714876,  0.03256714876,
                -0.03256714876,  0.03256714876;
  // clang-format on
