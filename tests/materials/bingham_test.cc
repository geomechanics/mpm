...
TEST_CASE("Bingham is checked in 2D (without thixotropy)",
  ...
  SECTION("Bingham check stresses with strain rate") {
    ...
    REQUIRE(check_stress(0) == Approx(-53239.7900274234).epsilon(Tolerance));
    REQUIRE(check_stress(1) == Approx(-53240.7959929121).epsilon(Tolerance));
    REQUIRE(check_stress(2) == Approx(1.6766091478).epsilon(Tolerance));
    REQUIRE(check_stress(3) == Approx(-2.5149137217).epsilon(Tolerance));
...
TEST_CASE("Bingham is checked in 2D (with thixotropy)",
  ...
  SECTION("Bingham check stresses with strain rate") {
    ...
    // Check stressees
    REQUIRE(check_stress.size() == 6);
    REQUIRE(check_stress(0) == Approx(-53240.1001639861).epsilon(Tolerance));
    REQUIRE(check_stress(1) == Approx(-53242.0365391630).epsilon(Tolerance));
    REQUIRE(check_stress(2) == Approx(3.2272919615).epsilon(Tolerance));
    REQUIRE(check_stress(3) == Approx(-4.8409379422).epsilon(Tolerance));
    REQUIRE(check_stress(4) == Approx(0.000e+00).epsilon(Tolerance));
    REQUIRE(check_stress(5) == Approx(0.000e+00).epsilon(Tolerance));
  }
}
...
TEST_CASE("Bingham is checked in 3D (without thixotropy)",
  ...
  SECTION("Bingham check stresses with strain rate") {
    ...
    // Check stressees
    REQUIRE(check_stress.size() == 6);
    REQUIRE(check_stress(0) == Approx(-15728.3671338958).epsilon(Tolerance));
    REQUIRE(check_stress(1) == Approx(-15725.9732154129).epsilon(Tolerance));
    REQUIRE(check_stress(2) == Approx(-15729.6270909921).epsilon(Tolerance));
    REQUIRE(check_stress(3) == Approx(-0.5669806933).epsilon(Tolerance));
    REQUIRE(check_stress(4) == Approx(-0.1889935644).epsilon(Tolerance));
    REQUIRE(check_stress(5) == Approx(-1.8899356444).epsilon(Tolerance));
  }
}
...
TEST_CASE("Bingham is checked in 3D (with thixotropy)",
  ...
  SECTION("Bingham check stresses with strain rate") {
    ...
    // Check stressees
    REQUIRE(check_stress.size() == 6);
    REQUIRE(check_stress(0) == Approx(-15728.7168040748).epsilon(Tolerance));
    REQUIRE(check_stress(1) == Approx(-15724.1083077915).epsilon(Tolerance));
    REQUIRE(check_stress(2) == Approx(-15731.1423284344).epsilon(Tolerance));
    REQUIRE(check_stress(3) == Approx(-1.0914859618).epsilon(Tolerance));
    REQUIRE(check_stress(4) == Approx(-0.3638286539).epsilon(Tolerance));
    REQUIRE(check_stress(5) == Approx(-3.6382865394).epsilon(Tolerance));
  }
}