...
TEST_CASE("NorSand is checked in 3D non-bonded model",
  ...
  SECTION("NorSand check undrained stresses after yielding with bonded model") {
    ...
    Eigen::Matrix<double, 6, 6> dep_check;
    // clang-format off
    dep_check << 3683241.27841,  17317764.2758,  17317764.2758,              0,              0,              0,
                 17317764.2758,  9422661.78508, -286517.042372,              0,              0,              0,
                 17317764.2758, -286517.042372,  9422661.78508,              0,              0,              0,
...
TEST_CASE("NorSand is checked in 3D bonded model", "[material][NorSand][3D]") {
  ...
  SECTION("NorSand check undrained stresses after yielding with bonded model") {
    ...
    dep_check <<  12000427.4924,  16078853.6317,  16078853.6317,              0,              0,              0,
                  16078853.6317,  8697439.18576, -1940329.88084,              0,              0,              0,
                  16078853.6317, -1940329.88084,  8697439.18576,              0,              0,              0,
