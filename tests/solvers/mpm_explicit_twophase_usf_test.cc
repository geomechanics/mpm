...
// Check MPM Explicit
TEST_CASE("MPM 2D Explicit TwoPhase implementation is checked",
          "[MPM][2D][Explicit][USF][2Phase]") {
  // Dimension
  ...
  char* argv[] = {(char*)"./mpm",
                  (char*)"-f",  (char*)"./",
                  (char*)"-i",  (char*)"mpm-explicit-twophase-usf-2d.json"};
  // clang-format on
...
// Check MPM Explicit
TEST_CASE("MPM 3D Explicit TwoPhase implementation is checked",
          "[MPM][3D][Explicit][USF][2Phase]") {
  // Dimension
  ...
  char* argv[] = {(char*)"./mpm",
                  (char*)"-f",  (char*)"./",
                  (char*)"-i",  (char*)"mpm-explicit-twophase-usf-3d.json"};
  // clang-format on
