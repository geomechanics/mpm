...
// Check MPM Implicit
TEST_CASE("MPM 2D Implicit Multiple Particle Type implementation is checked",
          "[MPM][2D][Implicit][2Types]") {
  // Dimension
  ...
  REQUIRE(mpm_test::write_json_implicit_multi_particle_type(
  ...
  // Write Particles
  REQUIRE(mpm_test::write_particles_2d_multi_particle_type() == true);
  ...
  char* argv[] = {(char*)"./mpm",
                  (char*)"-f",  (char*)"./",
                  (char*)"-i",  (char*)"mpm-implicit-multi-ptype-2d.json"};
  // clang-format on
...
// Check MPM Implicit
TEST_CASE("MPM 3D Implicit Multiple Particle Type implementation is checked",
          "[MPM][3D][Implicit][2Types]") {
  // Dimension
  ...
  // Write Particles
  REQUIRE(mpm_test::write_particles_3d_multi_particle_type() == true);
  ...
  char* argv[] = {(char*)"./mpm",
                  (char*)"-f",  (char*)"./",
                  (char*)"-i",  (char*)"mpm-implicit-multi-ptype-3d.json"};
  // clang-format on
